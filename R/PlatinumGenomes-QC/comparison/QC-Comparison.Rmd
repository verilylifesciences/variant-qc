...
Lastly, the 'expanded table' used in the query only contains non-variant segments for SNPs (i.e. indels matching the reference are not included). Thus, indels were also excluded from the above analysis as they would result in inaccurate statistics.
