...
queryReplacements <- list("_GENOME_CALL_TABLE_"="genomics-public-data:1000_genomes.variants",
                          "_MULTISAMPLE_VARIANT_TABLE_"="genomics-public-data:1000_genomes.variants",
