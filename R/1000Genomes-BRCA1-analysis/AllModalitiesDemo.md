...
---
title: "Data Analyis using the Genomics API"
output:
  html_document:
    keep_md: yes
    toc: yes
...
See also [GABrowse](See Also http://gabrowse.appspot.com/#=&readsetId=CJDmkYn8ChCcnc7i4KaWqmQ&backend=GOOGLE) for an interactive Reads browser.
