...
```{r fig.align="center", fig.width=10, message=FALSE, comment=NA}
require(ggplot2)
ggplot(pca_1kg) +
...
```{r echo=FALSE, eval=FALSE, message=FALSE, comment=NA}
...
```{r fig.align="center", fig.width=10, message=FALSE, warning=FALSE, comment=NA}
require(ggbio)
