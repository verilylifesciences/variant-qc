...
```{r echo=FALSE, eval=FALSE}
# To install these packages (only need to do this once)
...
```{r alt-counts, fig.align="center", fig.width=10, message=FALSE, comment=NA}
...
```{r brca1-pca-with-gender, fig.align="center", fig.width=10, message=FALSE, comment=NA}
